...
class Avto(models.Model):
    ...
    savdolashuv = models.CharField(max_length=99, choices=SAVSTATUS, default=None)
    photo = models.ManyToManyField(Photo , verbose_name='Rasm')
    xolati = models.CharField(max_length=99, choices=XOLATSTATUS, default=None)
    ...
    dvigatel = models.CharField(max_length=3, verbose_name='Dvigatel Hajmi', null=True, blank=True)
